...
import css from './CellItem.less';

class CellItem extends Component {
    constructor(props){
        super(props);
        // this.img_right  = require("./right_click_icon.png");
        this.img_right  = window.imgHost + ("/images/icon_right.png");
    }
    render() {
        ...
        var cell = (
            <div
                ...
                className={css.cell}>
                {leftIcon}
                <div className={item.show_icon?css.cellMain:css.refCellMain}>
                    <div className={item.show_icon?css.center:css.centerLeftNone}>

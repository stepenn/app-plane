...
import css from './InputCell.less';
class InputCell extends Component{
    ...
    render(){
        ...
        if(data.viewSend){
            ...
            viewSend = (
                <div className={autoTimeExe ? css.verBtn : css.verBtnNO} onClick={() => {
                    if (autoTimeExe) {
                        //验证手机号
        ...
        var viewLeft= data.icon?
            <img className={css.rowImg} src={data.icon}/>
            :
            <div className={css.rowLeft}>
                {data.title}:
            </div>;
        var cssInput = data.icon?css.rowInputIcon:css.rowInputTitle;
        var cssInputError = data.icon?css.rowInputIconError:css.rowInputTitleError;
        ...
        return (
            <div className={data.hidden?css.hidden:css.row}>
                ...
                >
                    <input
                        ...
                        className={this.state.state ==-1?cssInputError:cssInput}
                ...
                <img
                    ...
                    className={(this.state.show&&!data.noedit)?css.rowClear:css.rowClearH}
                    src={this.img_clear}/>
                {viewSend}
            </div>
        );
